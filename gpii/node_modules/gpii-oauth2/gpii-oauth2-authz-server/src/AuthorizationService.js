...
gpii.oauth2.authorizationService.savePrefs = function (preferencesDataSource, preferences, view) {
    fluid.log("gpii.oauth2.authorizationService.savePrefs: entering");
    fluid.log("gpii.oauth2.authorizationService.savePrefs: preferencesDataSource: " + JSON.stringify(preferencesDataSource, null, 2));
    fluid.log("gpii.oauth2.authorizationService.savePrefs: preferences: " + JSON.stringify(preferences, null, 2));
    fluid.log("gpii.oauth2.authorizationService.savePrefs: view: " + view);
    view = view || "";

    fluid.log("gpii.oauth2.authorizationService.savePrefs: calling preferencesDataSource.set(...)");
